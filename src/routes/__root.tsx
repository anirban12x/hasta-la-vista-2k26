...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "An immersive TMSL CSE Department farewell experience for the 2026 passout batch. Where goodbyes turn into beautiful stories." },
      { name: "author", content: "Hasta La Vista Core Committee · TMSL CSE" },
      { property: "og:title", content: "Hasta La Vista 2026 — TMSL CSE Dept Farewell" },
      { property: "og:description", content: "Where goodbyes turn into beautiful stories. A cinematic farewell for TMSL CSE 2026 batch." },
