...
export const Route = createFileRoute("/gallery")({
  head: () => ({
    meta: [
      { title: "Best Moments Captured — Hasta La Vista 2026" },
      { name: "description", content: "Memories from the TMSL CSE 2026 passout batch — every frame, a story and every click a goodbye preserved." },
      { property: "og:title", content: "Best Moments Captured · TMSL CSE Farewell 2026" },
    ...
    <div className="pt-32">
      <section className="relative px-6 py-12 text-center">
        ...
        <p className="mx-auto mt-6 max-w-2xl font-body text-[#FFF8DC]/75">
          Frozen seconds. Stolen smiles. The kind of pictures you keep returning to, just to feel that Day again.
        </p>
      </section>
          ...
          <div className="columns-1 gap-4 sm:columns-2 lg:columns-3 xl:columns-4">
            {galleryImages.map((src, i) => (
              ...
              >
                <img
                  src={src}
                  alt="TMSL CSE farewell 2026 moment"
                  loading="lazy"
      ...
      <section className="relative my-20 overflow-hidden border-y-2 border-[#DAA520]/50 py-24 text-center"
        ...
        <p className="mt-6 font-body text-lg italic text-[#FFF8DC]/80 md:text-xl">
          To the TMSL CSE 2026 passout batch — the world is luckier with you in it.
        </p>
      </section>
    </div>
  );
