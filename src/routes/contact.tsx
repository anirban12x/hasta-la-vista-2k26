...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Get In Touch — Hasta La Vista 2026" },
      { name: "description", content: "Reach the Hasta La Vista Core Committee — for registration, sponsorship, or queries for the TMSL CSE 2026 passout batch farewell." },
      { property: "og:title", content: "Contact · TMSL CSE Farewell 2026" },
...
function ContactPage() {
  ...
  const submit = (e: React.FormEvent) => {
    e.preventDefault();
    toast.success("Your message has reached the Core Committee ✦", {
